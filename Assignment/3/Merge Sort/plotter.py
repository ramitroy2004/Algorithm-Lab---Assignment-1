...
if choice == 1:
    data = pd.read_csv(r'C:\Users\mindl\Desktop\AlgoLab\3\Merge Sort\observation_uniform.csv')
elif choice == 2:
    data = pd.read_csv(r'C:\Users\mindl\Desktop\AlgoLab\3\Merge Sort\observation_normal.csv')
